...
$sth = $dbconnection->prepare("INSERT INTO `usjr`.`programs` VALUES(?,?,?,?,?)");
$sth->bindParam(1, $_POST['prog-id'], PDO::PARAM_INT);
$sth->bindParam(2, $_POST['prog-full-name'], PDO::PARAM_STR);
$sth->bindParam(3, $_POST['prog-short-name'], PDO::PARAM_STR);
$sth->bindParam(4, $_POST['college-select'], PDO::PARAM_INT);
$sth->bindParam(5, $_POST['department-select'], PDO::PARAM_INT);
